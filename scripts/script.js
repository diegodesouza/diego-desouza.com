$(document).ready(function() {
  ...
  // animate bar underneath Navigation
  var animateBar = function() {
    $('.navigation-trigger').click(function() {
      $('.section-menu-horizontal-line').animate({ width: '150px' }, 500)
  ...
  // animate button (ripple effect) // refactor this!
